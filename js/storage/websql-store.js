var WebSqlStore = function(successCallback, errorCallback) {
    ...
    this.addSampleData = function(tx, employees) {
        var employees = [
                ...
                {"id": 15, "firstName": "Shelly", "lastName": "Altman", "title":"Human Resources", "managerId": 1, "city":"Scranton, PA", "cellPhone":"570-485-8554", "officePhone":"570-699-5577", "email":"toby@dundermifflin.com"}
            ];
